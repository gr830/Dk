...
- в дальнейшем будет подтягиваться Тц в производственный заказ и если нет расчетного то браться отсюда при расчете интенсивности, пишем интенсивность 0,8 т.к. если ничего не вписать то не сохраняться изменения в альтернативе
...
После 
- внесим изменении в мастере данных (если необходимо! )
...
**! В мастере данных храняться только актуальные расчеты титова, либо фактический которые идут быстрее всего в данный момент**
...
## Работа с файлом предварительного расчета дателей в заказе
...
**Вписываем габариты в зависемости от типа заготовки**
...
**Указываем количество установов (операций)**
